...
var PageTransitions = (function ($, options) {
  ...
  function init(options) {
    ...
    $(".animated-section").each(function () {
      var $page = $(this);
      $page.data("originalClassList", $page.attr("className"));
    });
    ...
    $("body").append(
      '<div id="page-ajax-loaded" className="page-ajax-loaded animated animated-section-moveFromLeft"></div>'
    );
    ajaxLoader();
  ...
  function resetPage($nextPage, $currentPage) {
    $currentPage.attr("className", $currentPage.data("originalClassList"));
    $nextPage.attr(
      "className",
